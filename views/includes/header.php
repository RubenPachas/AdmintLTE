...
//S1: Obtener el perfil del usuario
$listaPermisos = $_SESSION['login']['permisos'];

//Obtenr la vista y validar con "listaPermiso"
$urlCompleta = $_SERVER['REQUEST_URI'];
$arrayURL = explode("/", $urlCompleta); //llama el array de vista en el perfil
$vistaActual = end($arrayURL); //Sacar el utlimo elemento del array 
